...
public class SiccusWorldProvider extends WorldProviderSpace implements IExitHeight, ISolarLevel, ITeleportType {
    ...
    {
        return GalaxyMultiverse.planetSiccus;
    }

    @Override
    public Class<? extends IChunkProvider> getChunkProviderClass() {
        return SiccusChunkProvider.class;
    }
    ...
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return SiccusWorldChunkManager.class;
    }
