...
public class MediusChunkProvider extends ChunkProviderSpace
{
    public MediusChunkProvider(World par1World, long seed, boolean mapFeaturesEnabled) {
    ...
    protected BiomeDecoratorSpace getBiomeGenerator() {
        ...
        return new MediusBiomeDecorator();
    }
