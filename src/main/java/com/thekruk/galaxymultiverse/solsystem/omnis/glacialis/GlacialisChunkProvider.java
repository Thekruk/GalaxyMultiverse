...
public class GlacialisChunkProvider extends ChunkProviderSpace
{
    public GlacialisChunkProvider(World par1World, long seed, boolean mapFeaturesEnabled) {
    ...
    protected BiomeDecoratorSpace getBiomeGenerator() {
        ...
        return new GlacialisBiomeDecorator();
    }
