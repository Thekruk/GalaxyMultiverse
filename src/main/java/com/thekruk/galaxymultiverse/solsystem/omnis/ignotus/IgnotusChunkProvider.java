...
public class IgnotusChunkProvider extends ChunkProviderSpace
{
    public IgnotusChunkProvider(World par1World, long seed, boolean mapFeaturesEnabled) {
    ...
    protected BiomeDecoratorSpace getBiomeGenerator() {
        ...
        return new IgnotusBiomeDecorator();
    }
