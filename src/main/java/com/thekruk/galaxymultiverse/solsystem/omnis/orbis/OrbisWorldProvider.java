...
public class OrbisWorldProvider extends WorldProviderSpace implements IExitHeight, ISolarLevel, ITeleportType {
    ...
    {
        return GalaxyMultiverse.planetOrbis;
    }

    @Override
    public Class<? extends IChunkProvider> getChunkProviderClass() {
        return OrbisChunkProvider.class;
    }
    ...
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return OrbisWorldChunkManager.class;
    }
