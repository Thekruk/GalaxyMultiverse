...
public class FrigusChunkProvider extends ChunkProviderSpace
{
    public FrigusChunkProvider(World par1World, long seed, boolean mapFeaturesEnabled) {
    ...
    protected BiomeDecoratorSpace getBiomeGenerator() {
        ...
        return new FrigusBiomeDecorator();
    }
