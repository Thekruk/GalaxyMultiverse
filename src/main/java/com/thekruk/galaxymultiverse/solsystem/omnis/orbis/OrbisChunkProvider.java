...
public class OrbisChunkProvider extends ChunkProviderSpace
{
    public OrbisChunkProvider(World par1World, long seed, boolean mapFeaturesEnabled) {
    ...
    protected BiomeDecoratorSpace getBiomeGenerator() {
        ...
        return new OrbisBiomeDecorator();
    }
