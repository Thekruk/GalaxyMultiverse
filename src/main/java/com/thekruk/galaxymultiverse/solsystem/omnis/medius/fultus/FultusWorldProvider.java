...
public class FultusWorldProvider extends WorldProviderSpace implements IExitHeight, ISolarLevel, ITeleportType {
    ...
    {
        return GalaxyMultiverse.moonFultus;
    }

    @Override
    public Class<? extends IChunkProvider> getChunkProviderClass() {
        return FultusChunkProvider.class;
    }
    ...
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return FultusWorldChunkManager.class;
    }
