...
public class SiccusChunkProvider extends ChunkProviderSpace
{
    public SiccusChunkProvider(World par1World, long seed, boolean mapFeaturesEnabled) {
    ...
    protected BiomeDecoratorSpace getBiomeGenerator() {
        ...
        return new SiccusBiomeDecorator();
    }
