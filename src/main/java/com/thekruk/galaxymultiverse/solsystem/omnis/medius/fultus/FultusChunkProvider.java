...
public class FultusChunkProvider extends ChunkProviderSpace
{
    public FultusChunkProvider(World par1World, long seed, boolean mapFeaturesEnabled) {
    ...
    protected BiomeDecoratorSpace getBiomeGenerator() {
        ...
        return new FultusBiomeDecorator();
    }
